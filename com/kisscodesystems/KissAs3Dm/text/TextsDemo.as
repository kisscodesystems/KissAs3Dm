...
package com . kisscodesystems . KissAs3Dm . text
{
  ...
  public class TextsDemo extends Texts
  {
    ...
    public const DISPLAYING_STYLE_1 : String = _BTC + "DISPLAYING_STYLE_1" + _ETC ;
    public const DISPLAYING_STYLE_2 : String = _BTC + "DISPLAYING_STYLE_2" + _ETC ;
    public const DISPLAYING_STYLE_3 : String = _BTC + "DISPLAYING_STYLE_3" + _ETC ;
    public const DISPLAYING_STYLE_4 : String = _BTC + "DISPLAYING_STYLE_4" + _ETC ;
    public const DISPLAYING_STYLE_5 : String = _BTC + "DISPLAYING_STYLE_5" + _ETC ;
    public const DISPLAYING_STYLE_6 : String = _BTC + "DISPLAYING_STYLE_6" + _ETC ;
    public const WIDGET_TAB_BASIC : String = _BTC + "WIDGET_TAB_BASIC" + _ETC ;
    public const WIDGET_TYPE_COMPONENT_USAGE : String = _BTC + "WIDGET_TYPE_COMPONENT_USAGE" + _ETC ;
    public const WIDGET_TYPE_SINGLE_LINE_TEXTS : String = _BTC + "WIDGET_TYPE_SINGLE_LINE_TEXTS" + _ETC ;
    public const WIDGET_TYPE_MULTI_LINE_TEXTS : String = _BTC + "WIDGET_TYPE_MULTI_LINE_TEXTS" + _ETC ;
    public const WIDGET_TYPE_BUTTONS : String = _BTC + "WIDGET_TYPE_BUTTONS" + _ETC ;
    public const WIDGET_TYPE_PICKERS : String = _BTC + "WIDGET_TYPE_PICKERS" + _ETC ;
    public const WIDGET_TYPE_OTHERS : String = _BTC + "WIDGET_TYPE_OTHERS" + _ETC ;
    public const WIDGET_TYPE_CAMERA : String = _BTC + "WIDGET_TYPE_CAMERA" + _ETC ;
    public const WIDGET_TYPE_BOARD : String = _BTC + "WIDGET_TYPE_BOARD" + _ETC ;
    public const WIDGET_HEADER_COMPONENT_USAGE : String = _BTC + "WIDGET_HEADER_COMPONENT_USAGE" + _ETC ;
    public const WIDGET_HEADER_SINGLE_LINE_TEXTS : String = _BTC + "WIDGET_HEADER_SINGLE_LINE_TEXTS" + _ETC ;
    public const WIDGET_HEADER_MULTI_LINE_TEXTS : String = _BTC + "WIDGET_HEADER_MULTI_LINE_TEXTS" + _ETC ;
    public const WIDGET_HEADER_BUTTONS : String = _BTC + "WIDGET_HEADER_BUTTONS" + _ETC ;
    public const WIDGET_HEADER_PICKERS : String = _BTC + "WIDGET_HEADER_PICKERS" + _ETC ;
    public const WIDGET_PICKERS_COLORS : String = _BTC + "WIDGET_PICKERS_COLORS" + _ETC ;
    public const WIDGET_PICKERS_DATES : String = _BTC + "WIDGET_PICKERS_DATES" + _ETC ;
    public const WIDGET_PICKERS_LISTS : String = _BTC + "WIDGET_PICKERS_LISTS" + _ETC ;
    public const WIDGET_HEADER_OTHERS : String = _BTC + "WIDGET_HEADER_OTHERS" + _ETC ;
    public const WIDGET_HEADER_CAMERA : String = _BTC + "WIDGET_HEADER_CAMERA" + _ETC ;
    public const WIDGET_HEADER_BOARD : String = _BTC + "WIDGET_HEADER_BOARD" + _ETC ;
    ...
    public const DATES : String = _BTC + "DATES" + _ETC ;
    public const DATE_PICKERS : String = _BTC + "DATE_PICKERS" + _ETC ;
    ...
    public const MENU_ITEM_MULTI_LINE_TEXTS : String = _BTC + "MENU_ITEM_MULTI_LINE_TEXTS" + _ETC ;
    public const MENU_ITEM_TEXTS : String = _BTC + "MENU_ITEM_TEXTS" + _ETC ;
    public const MENU_ITEM_BUTTONS : String = _BTC + "MENU_ITEM_BUTTONS" + _ETC ;
    public const MENU_ITEM_PICKERS : String = _BTC + "MENU_ITEM_PICKERS" + _ETC ;
    public const MENU_ITEM_BOARD : String = _BTC + "MENU_ITEM_BOARD" + _ETC ;
    public const MENU_ITEM_OTHERS : String = _BTC + "MENU_ITEM_OTHERS" + _ETC ;
    public const WIDGETINFO_COMPONENT_USAGE : String = _BTC + "WIDGETINFO_COMPONENT_USAGE" + _ETC ;
    public const WIDGETINFO_CAMERA : String = _BTC + "WIDGETINFO_CAMERA" + _ETC ;
    public const WIDGETINFO_SINGLE_LINE_TEXTS : String = _BTC + "WIDGETINFO_SINGLE_LINE_TEXTS" + _ETC ;
    public const WIDGETINFO_MULTI_LINE_TEXTS : String = _BTC + "WIDGETINFO_MULTI_LINE_TEXTS" + _ETC ;
    public const WIDGETINFO_BUTTONS : String = _BTC + "WIDGETINFO_BUTTONS" + _ETC ;
