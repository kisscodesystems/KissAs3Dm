  ...
  public class PickersWidget extends Widget
  {
    ...
    override protected function onCreate ( ) : void
    {
      if ( ! loaded )
      {
        ...
        addToContent ( colorsIndex , textLabelColor , false , 0 ) ;
        textLabelColor . setTextCode ( TextsDemo ( application . getTexts ( ) ) . COLORS ) ;
        colorEnabled = new ColorPanel ( application ) ;
        addToContent ( colorsIndex , colorEnabled , true , 1 ) ;
        colorEnabled . setRGBColor ( application . getPropsDyn ( ) . getAppBackgroundFillFgColor ( ) . toString ( 16 ) ) ;
        textLabelColorPicker = new TextLabel ( application ) ;
        addToContent ( colorsIndex , textLabelColorPicker , false , 2 ) ;
        ...
        addToContent ( listsIndex , listPickerDisabled , true , 5 ) ;
