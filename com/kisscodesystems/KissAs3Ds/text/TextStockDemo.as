...
*/
package com . kisscodesystems . KissAs3Ds . text
{
...
*/
    private function textIni2 ( ) : void
    {
      ...
      texts [ textCodesDisplayingStyles [ 0 ] ] . push ( "Alap" ) ;
      texts [ textCodesDisplayingStyles [ 1 ] ] = [ "Balaton" , "Balaton" ] ;
      texts [ textCodesDisplayingStyles [ 2 ] ] = [ "Style 01" , "Stílus 01" ] ;
      texts [ textCodesDisplayingStyles [ 3 ] ] = [ "Style 02" , "Stílus 02" ] ;
      texts [ textCodesDisplayingStyles [ 4 ] ] = [ "Style 03" , "Stílus 03" ] ;
      texts [ textCodesDisplayingStyles [ 5 ] ] = [ "Style 04" , "Stílus 04" ] ;
      texts [ textCodesDisplayingStyles [ 6 ] ] = [ "Style 05" , "Stílus 05" ] ;
      texts [ textCodesDisplayingStyles [ 7 ] ] = [ "Style 06" , "Stílus 06" ] ;
      texts [ textCodesDisplayingStyles [ 8 ] ] = [ "Style 07" , "Stílus 07" ] ;
      texts [ textCodesDisplayingStyles [ 9 ] ] = [ "Style 08" , "Stílus 08" ] ;
      texts [ textCodesDisplayingStyles [ 10 ] ] = [ "Style 09" , "Stílus 09" ] ;
      texts [ textCodesDisplayingStyles [ 11 ] ] = [ "Style 10" , "Stílus 10" ] ;
      texts [ textCodesDisplayingStyles [ 12 ] ] = [ "Style 11" , "Stílus 11" ] ;
      texts [ textCodesDisplayingStyles [ 13 ] ] = [ "Style 12" , "Stílus 12" ] ;
      texts [ textCodesDisplayingStyles [ 14 ] ] = [ "Style 13" , "Stílus 13" ] ;
      texts [ textCodesDisplayingStyles [ 15 ] ] = [ "Style 14" , "Stílus 14" ] ;
      ...
      texts [ TextsDemo ( application . getTexts ( ) ) . WIDGET_HEADER_DEMO_CAMERA ] = [ "Camera" , "Kamera" ] ;
      ...
      texts [ TextsDemo ( application . getTexts ( ) ) . COLORS ] = [ "Colors:" , "Színek:" ] ;
      texts [ TextsDemo ( application . getTexts ( ) ) . COLOR_PICKERS ] = [ "Colorpickers:" , "Színválasztók:" ] ;
      texts [ TextsDemo ( application . getTexts ( ) ) . DATES ] = [ "Dates:" , "Dátumok:" ] ;
      texts [ TextsDemo ( application . getTexts ( ) ) . DATE_PICKERS ] = [ "Datepickers:" , "Dátumválasztók:" ] ;
      ...
      texts [ TextsDemo ( application . getTexts ( ) ) . CAMERA ] = [ "Above is the using of the camera." , "Föntebb a kamera használata." ] ;
