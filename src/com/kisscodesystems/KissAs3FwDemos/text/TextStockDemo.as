...
*/
package com . kisscodesystems . KissAs3FwDemos . text
{
...
*/
    private function textIni2 ( ) : void
    {
      ...
      texts [ TextsDemo ( application . getTexts ( ) ) . CHECKBOX_CHECKED ] = [ "Checkbox checked!" , "Checkbox jelölve!" ] ;
      texts [ TextsDemo ( application . getTexts ( ) ) . CHECKBOX_UNCHECKED ] = [ "Unchecked.." , "Visszajelölve.." ] ;
      ...
      texts [ application . getTexts ( ) . SETTING_BACKGROUND_FIXED ] . push ( "A háttér rögzített." ) ;
      ...
      texts [ application . getTexts ( ) . COMPONENTS_USAGE ] . push ( "<p><b>Üdvözlet a KissAs3Fw framework-ben!</b></p>" + application . EMPTY_HTML_PARAGRAPH + "<p>Alább olvasható a komponens set használata.</p>" + application . EMPTY_HTML_PARAGRAPH + "<p><i>Ha 2 négyzet található egymásban, akkor bal egér gomb nyomvatartással (egy tiszta területen) a tartalom mozgatható.</i></p>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ButtonBar</b>" + "<li><u>ButtonLink gyűjtemény.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ButtonDraw</b>" + "<li><u>Gomb objektum rajzolt formával.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ButtonLink</b>" + "<li><u>Link objektum amely klikkelhető.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ButtonText</b>" + "<li><u>Egyszerű gomb objektum megjelenített szöveggel.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>Checkbox</b>" + "<li><u>Checkbox..</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>Color</b>" + "<li><u>Szín kiválasztó panel.</u></li>" + "<li>Eredeti szín kiválasztása: klikk a default szín formán.</li>" + "<li>Tetszőleges szín a stage-ről: klikk az ideiglenes szín formán.</li>" + "<li>Tetszőleges szín RGB-vel: input mezőbe beírni.</li>" + "<li>Előre definiált megadása: klikk a kis négyzeten vagy a színezett sávon.</li>" + "<li>Szín véglegesítése: klikk az OK gombon.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ColorPicker</b>" + "<li><u>Színt választ a Color objektum segítségével.</u></li>" + "<li>Működtetés: klikk a színezett formán.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ContentMultiple</b>" + "<li><u>Tartalomkezelő objektum (több lap).</u></li>" + "<li>Például a beállítás panelen.</li>" + "<li>Tartlom választás: klikk a gombsoron.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ContentSingle</b>" + "<li><u>Tartalomkezelő objektum (1 lap).</u></li>" + "<li>Bármelyik egyszerű Widget belsejében.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>List</b>" + "<li><u>Egy vagy több kiválasztható elemek gyűjteménye.</u></li>" + "<li>Kiválaszt: klikk egy elem fölött.</li>" + "<li>Pozícionál: bal egér gomb a listán és húz</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>ListPicker</b>" + "<li><u>Lista egy kiválasztható elemmel, egy sorban.</u></li>" + "<li>(Mint a combobox.)</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>Potmet</b>" + "<li><u>Számok megjelenítése határok között.</u></li>" + "<li>Minimum maximum és növekmény értékek.</li>" + "<li>A pontosság beállítható.</li>" + "<li>Érték változtatás: klikk a potmeten és húz.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>TextArea</b>" + "<li><u>Többsoros szöveg szerkesztésére.</u></li>" + "<li>Pozícionál: bal egér gomb a szövegen és húz</li>" + "<li>Szerkesztő mód: klikk a szövegre.</li>" + "<li>Olvasó mód: klikk máshová.</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>TextBox</b>" + "<li><u>Többsoros szöveg megjelenítésére.</u></li>" + "<li>Pozícionál: bal egér gomb a szövegen és húz</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>TextInput</b>" + "<li><u>Egysoros szövegbeviteli mező.</u></li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>TextLabel</b>" + "<li><u>Egy vagy többsoros szövegek megjelenítésére.</u></li>" + "<li>3 típus (különböző betűszín)</li>" + application . EMPTY_HTML_PARAGRAPH + "<ul><b>Widget</b>" + "<li><u>Egybetartozó tartalom kezelésére szolgáló felület.</u></li>" + "<li>Pozícionál: bal egér gomb a fejlécen és húz</li>" + "<li>Mérezet: bal egér gomb a widget szélén és húz</li>" + "<li>Elrejt - felfed: klikk a fejlécen</li>" + "<li>Navigál: klikk az = ikonra (minden widgeten)</li>" + "<li>Bezár: dupla klikk a fejléc címkén</li>" + "</ul>" ) ;
