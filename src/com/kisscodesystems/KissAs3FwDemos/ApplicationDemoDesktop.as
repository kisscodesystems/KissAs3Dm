/*
** This class is a part of the KissAs3FwDemos application.
** See the header comment lines of the
** com . kisscodesystems . KissAs3FwDemos . ApplicationDemoDesktop
...
** 0: embedding the resource as seen in the object variables of ApplicationDemoDesktop (bg2.jpg)
** 1: creating the new objects of the new bitmaps as seen in the doFirstIni of ApplicationDemoDesktop
...
**
** Adding new fonts:
** 0: embedding the resource as seen in the object variables of ApplicationDemoDesktop (Palatino Linotype)
...
**
** ApplicationDemoDesktop is free software: you can redistribute it and/or modify
** it under the terms of the GNU General Public License as published by
** Free Software Foundation, version 3.
**
** ApplicationDemoDesktop is distributed in the hope that it will be useful,
** but WITHOUT ANY WARRANTY; without even the implied warranty of
** MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
** GNU General Public License for more details.
**
** You should have received a copy of the GNU General Public License
** along with ApplicationDemoDesktop. If not, see <http://www.gnu.org/licenses/>.
*/
package com . kisscodesystems . KissAs3FwDemos
{
  ...
  import com . kisscodesystems . KissAs3FwDemos . prop . PropsAppDemo ;
  import com . kisscodesystems . KissAs3FwDemos . prop . PropsDynDemo ;
  import com . kisscodesystems . KissAs3FwDemos . text . TextStockDemo ;
  import com . kisscodesystems . KissAs3FwDemos . text . TextsDemo ;
  import flash . events . ContextMenuEvent ;
  import flash . events . Event ;
  public class ApplicationDemoDesktop extends Application
  {
...
*/
    public function ApplicationDemoDesktop ( ) : void
    {
// Super.
      super ( ) ;
    }
...
// Adding new elements to the context menu.
