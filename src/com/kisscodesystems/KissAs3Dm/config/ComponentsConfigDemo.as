 ...
 *
 * DESCRIPTION:
 * ComponentsConfigDemo.
 * The components config of the KissAs3Dm application.
 *
 * MAIN FEATURES:
 * - it only binds the configuration xml of this application to the framework config
 * - the values themselves are in resource/config/KissAs3DmComponentsConfig.xml
...
package com.kisscodesystems.KissAs3Dm.config
{
  ...
  public class ComponentsConfigDemo extends ComponentsConfig
  {
    [Embed(source = "../resource/config/KissAs3DmComponentsConfig.xml", mimeType = "application/octet-stream")]
    ...
    /**
     * Constructs the components config of the KissAs3Dm application.
     * @param applicationRef the main application reference
     */
    public function ComponentsConfigDemo(applicationRef:Application):void
    {
      super(applicationRef);
      application.trace("<" + this + " ComponentsConfigDemo> called.", 4);
      application.trace("<" + this + " ComponentsConfigDemo> applicationRef: " + applicationRef, 3);
      application.trace("<" + this + " ComponentsConfigDemo> constructed.", 4);
    }
    /**
    ...
    {
      application.trace("<" + this + " ComponentsConfigDemo readValuesFromConfigXml> called.", 4);
    ...
    {
      application.trace("<" + this + " ComponentsConfigDemo destroy> called.", 4);
