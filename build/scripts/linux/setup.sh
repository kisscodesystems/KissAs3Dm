...
# For example
# JAVA=/usr/bin/java
# AIRSDK_HOME=/home/myUser/AIRSDK_51.2.1
# KISSAS3FW_SRC=/home/myUser/sources/KissAs3Fw/src
...
if [[ $AIRSDK_HOME == "" ]]
then
  AIRSDK_HOME=$(read_setting AIRSDK_HOME "the folder of the air sdk, for example /home/myUser/AIRSDK_51.2.1") || exit 2
fi
if [[ $KISSAS3FW_SRC == "" ]]
then
  KISSAS3FW_SRC=$(read_setting KISSAS3FW_SRC "the src folder of the KissAs3Fw checkout, for example /home/myUser/sources/KissAs3Fw/src") || exit 3
fi
if [[ $LICENSE_FILE == "" ]]
then
...
# down by KissAs3Dm_build_and_launch_linux.sh, and the ApplicationDemo gets
...
APPLICATION_NAME="$AS3_CLASSNAME-linux.app"
